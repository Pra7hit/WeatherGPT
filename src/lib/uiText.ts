...
const TEXT = {
  en: {
    ...
    micPreparing: "Preparing offline voice… tap to cancel",
    ...
    retrieved: "Retrieved",
    /* Field labels. These name the parts of the instrument, so they are set in
       the machine's voice: mono caps, wherever they appear. */
    station: "Station",
    invert: "Invert",
    voice: "Voice",
    close: "Close",
    ...
    sample: "Sample",
    sampleHint: "Pick an hour to read its numbers",
    tempAxis: "Temp °C",
    rainAxis: "Rain %",
    kind: {
  ...
  hi: {
    ...
    micPreparing: "ऑफ़लाइन वॉइस तैयार हो रही है… रोकने के लिए दबाएँ",
    ...
    model: "मॉडल",
    severity: "तीव्रता",
    fieldEmpty: "फ़ील्ड ख़ाली",
    sample: "चुनें",
    sampleHint: "किसी घंटे को चुनें, उसके आंकड़े दिखेंगे",
    tempAxis: "तापमान °C",
    rainAxis: "बारिश %",
    kind: {
